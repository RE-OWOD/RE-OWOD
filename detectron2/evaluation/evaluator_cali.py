...
def inference_on_dataset(model, data_loader, evaluator):
    ...
    score_file.close()
    # ================================================================
    # known_class_score_avg = np.mean(class_score[0:20], axis=1)
    # unknown_class_score_avg = np.mean(class_score[80], axis=0)
    # logger.info("known_class_score_avg:{}, known_class_score_avg:{}".format(known_class_score_avg, unknown_class_score_avg))
